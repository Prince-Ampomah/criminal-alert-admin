import 'package:criminal_alert_admin/notification/phone_token_notification.dart';
...
class AuthServices {
  ...
  Stream<User> get user {
    return _auth.onAuthStateChanged.map(_firebaseUserCustomized);
  }
  ...
  Future loginWithGoogle() async {
    try {
      ...
      await PoliceUser(uid: user.uid)
          .policeDetails(userUID, name, email, phoneNumber, photoUrl);
      await PhoneTokenClass(uid: user.uid).phoneToken();
